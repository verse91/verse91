...
- **バックエンドエンジニア** | **エディター**
<br></br>
- **プログラミング**: Typescript | Golang
- **フロントエンド:** ReactJS, NextJS
- **バックエンド:** Golang, ExpressJS (TypeORM, Prisma), API, 認証と認可 (OAuth, JWT), WebSocket
- **データベース:** PostgreSQL, MySQL, MongoDB, DynamoDB
<br></br>
- **ソーシャルビデオエディター** | **タイポグラフィモーショングラフィックス**
- **ウェブセキュリティは勉強中です。**
<br></br>
- 連絡先: **versedev.store@proton.me**
</details>
...
<h2 align="left"><img src="https://github.com/user-attachments/assets/32d977c6-dbc5-46cc-933e-995915d56840" width="35px"/> GitHub統計</h2> 
<table>
